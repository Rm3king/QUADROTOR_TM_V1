 ...
 * 注释掉某行即可在编译期关闭对应功能，无运行时开销。
 */
#define  USE_MAG              /* 启用磁力计航向融合 (Imu.c) */
#define  USE_LENGTH_LIM       /* 启用四元数长度限制 (Imu.c) */
//#define USE_HEAT            /* 启用传感器加热恒温 (Drv_heating.c) */
//#define USE_THERMOSTATIC    /* 启用恒温 PID 控制  (Drv_heating.c) */
