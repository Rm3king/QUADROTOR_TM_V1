...
//		_datatemp[0]=data;
//	}
//	else if(rxstate==1 && (data == HW_TYPE || data == 0XFF))
//	{
//		rxstate=2;
//		_datatemp[1]=data;
//	}
...
//    if(*(data_buf+3) != (num-6))    //判断数据长度是否正确
//        return;
//    for(u8 i=0; i<num-2; i++)
//    {
//    check_sum1 += *(data_buf+i);
//        check_sum2 += check_sum1;
//    }
//    if((check_sum1 != *(data_buf+num-2)) || (check_sum2 != *(data_buf+num-1)))    //判断sum校验
//        return;    	
//	
//	
...
//		{
//			OF_STATE 		= *(data_buf+5);
//			OF_DX2		= *((s16*)(data_buf+6))  ;
//			OF_DY2		= *((s16*)(data_buf+8)) ;
//			OF_DX2FIX	=  *((s16*)(data_buf+10))  ;
//			OF_DY2FIX	= *((s16*)(data_buf+12)) ;
...
//		{
//			OF_ALT = *((u32*)(data_buf+7));
//			of_check_f[1] = 1;
//		}
////		else if(*(data_buf+5)==1)//融合后高度信息
//		{
//			OF_ALT2 = OF_ALT = *((u32*)(data_buf+7));
//		}
//	}	
//	
